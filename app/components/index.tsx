...
import HydrationBoundary from '@/app/components/hydration-boundary'
...
const Main: FC<IMainProps> = () => {
  ...
  */
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && APP_INFO?.title) {
      document.title = `${APP_INFO.title} - Powered by Soika AI`
    }
  }, [])
  ...
  */
  ...
  return (
    <HydrationBoundary fallback={<Loading type='app' />}>
